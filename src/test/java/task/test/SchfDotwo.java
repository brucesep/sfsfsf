...
public class SchfDotwo {

    //Полное ДО для СЧФ второй функции. С отправкой квитанций и созданием уточнения и титула
    ...
    @Feature(value = "СЧФ - ФУНКЦИЯ 2, минимальное заполнение полей")
    ...
    public void workflowSchf(String adresat, String urla, String login, String passWord) {
        String schfDocname = FilLSchf.fillingSchf(2, adresat); // создаём документ СЧФ со второй функцией
        ...
        QvitkiFastRun.utochnenia(schfDocname, urla, login, passWord); // создание уточнения и проверка квитанций (все проверки встроены в методы) ЛОГАУТ
    }
